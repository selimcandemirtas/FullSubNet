...
class Dataset(BaseDataset):
    def __init__(self,
        ...
        noisy_dataset_list = self._offset_and_limit(noisy_dataset_list, noisy_dataset_offset, noisy_dataset_limit)
        ...
        if pre_load_noise:
            noisy_dataset_list = self._preload_dataset(noisy_dataset_list, remark="Noise Dataset")
